...
/**
 * Make an arbitrary string safe to use as a file or folder name.
 * @param {string} name
 * @param {string} [fallback]
 * @returns {string}
 */
export function sanitizeFilename(name, fallback = 'unnamed') {
...
/**
 * Return a variant of `baseName` that is not already in `used`, adding it.
 * @param {string} baseName
 * @param {Set<string>} used
 * @returns {string}
 */
export function dedupeName(baseName, used) {
...
/**
 * @param {Date} [date]
 * @returns {string} e.g. "2026-07-09_13-02-05"
 */
